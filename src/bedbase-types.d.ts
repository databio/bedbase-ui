...
export interface paths {
    ...
    "/v1/bed/umap": {
         ...
         * @description Create embedding for bed file
         */
        post: operations["embed_bed_file_v1_bed_umap_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/bed/search/text": {
         ...
         */
        get: operations["text_to_bed_search_v1_bed_search_text_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/bed/search/exact": {
        ...
        get: operations["exact_search_v1_bed_search_exact_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** Body_embed_bed_file_v1_bed_umap_post */
        Body_embed_bed_file_v1_bed_umap_post: {
            /**
             * File
             * Format: binary
...
export interface operations {
    ...
    list_beds_v1_bed_list_get: {
        parameters: {
            query?: {
                /** @description Limit (1-10000), default 1000 */
                limit?: number;
                offset?: number;
    ...
    embed_bed_file_v1_bed_umap_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody?: {
            content: {
                "multipart/form-data": components["schemas"]["Body_embed_bed_file_v1_bed_umap_post"];
            };
        };
        responses: {
            /** @description Successful Response */
